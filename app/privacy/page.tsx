    ...
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          please contact us using the information provided below. Upon receiving
        ...
        <p className="mb-4">
          ...
          backups for legal or legitimate business purposes. However, this data
          will not be used for active processing.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          would like to exercise any of your data rights, please contact us at:
        </p>
        <div className="mb-4">
      ...
      <section className="mb-8">
        ...
        <p className="font-semibold">Last Updated: May 15, 2023</p>
      </section>
    </div>
  );
};
